...
const addName = (event) => {
  ...
  if (nameExists) {
    const confirmed = window.confirm(`${nameExists} is already added to the phonebook, replace the old number with a new one?`)
    ...
    // update logic
    nameService.update(nameExists.id, nameObject).then((updatedPerson) => {
